...
<form method="post" name="writeform"
	  action="ch11writePro.jsp" onsubmit="return writeSave()">
	...
	<tr>
	 ...
	 <tr>
	   ...
	   <td width="330" align="left">
	      <input type="text" size="40" maxlength="30" name="email"
	      		 style="ime-mode:active;"></td><!-- inactive: 영문 -->
	 </tr>
	 <tr>
	 ...
	 <tr>
	   <td colspan=2 bgcolor="<%=value_c%>" align="center">
	   		...
	   		<input type="button" value="목록보기" OnClick="window.location='ch11list.jsp'">
	   	</td>
	 </tr>  
</table>
<%
